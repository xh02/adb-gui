...
namespace adbGUI.Forms
{
	public partial class MainForm : Form
	{
		...
		private void MainForm_Load(object sender, EventArgs e)
		{
			...
			this.label1.Location = new Point(this.Width * 326 / 1080, this.Height * 548 / 687);
		}
		private void Rtb_console_Resize(object sender, EventArgs e)
		{
			rtb_console.ScrollToCaret();
		//	this.label1.Location = new Point((int)(this.Width * 0.301), (int)(this.Height * 0.798));
		...
		private void Tsm_WirelessConnect_Click(object sender, EventArgs e)
		{
			...
			if (r.Match(ipadress).Success)
				...
				MessageBox.Show(@"请输入一个有效的IP地址", @"Error", MessageBoxButtons.OK,
					MessageBoxIcon.Information);
		}

		private void Tsb_AlwayClearConsole_CheckedChanged(object sender, EventArgs e)
		{
			HelperClass.AlwaysClearConsole = AlwaysClearConsole.Checked;
		}
        private void 关闭adb服务ToolStripMenuItem_Click(object sender, EventArgs e)
        {
			HelperClass.Execute("adb kill-server");
		}

        private void 打开shellToolStripMenuItem_Click(object sender, EventArgs e)
        {
			if (!string.IsNullOrEmpty(HelperClass.SelectedDevice))
			{
				var serial = "";
        ...
        private void rootAdbToolStripMenuItem_Click(object sender, EventArgs e)
        {
			HelperClass.Execute("adb root");
		}

        private void adbUnrootToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
			Form frm = GetForm("author");
			
			var t = Application.OpenForms[frm.Text];
